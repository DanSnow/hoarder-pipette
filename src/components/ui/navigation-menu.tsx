  ...
  return (
    <div className={cn('absolute top-full left-0 isolate z-50 flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          'data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 origin-top-center data-[state=closed]:animate-out data-[state=open]:animate-in relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border bg-popover text-popover-foreground shadow md:w-[var(--radix-navigation-menu-viewport-width)]',
          className,
        )}
        {...props}
      />
